...
public class ImportRegularTitle_Demo {

    public static void main(String[] args) throws Exception{
        System.out.println("=====导入季度数据======");
        final long start = System.currentTimeMillis();
        String areaQuarter = "src/test/resources/excel/ImportRegularTitle.xls";
        final List<ImportRegularTitle> quarterList = ExcelImportExportUtils.importExcel(new FileInputStream(areaQuarter), ImportRegularTitle.class, 2000);
