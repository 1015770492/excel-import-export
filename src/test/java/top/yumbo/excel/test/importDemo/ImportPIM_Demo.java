...
public class ImportPIM_Demo {
    ...
    public static void main(String[] args) throws Exception{
        String xlsx = "src/test/resources/excel/ImportPIM.xlsx";

        final List<ImportPIM> pimExcels = ExcelImportExportUtils.importExcel(WorkbookFactory.create(new FileInputStream(xlsx)).getSheetAt(0), ImportPIM.class);
