...
public class ExcelImportExportTemplateForYear {

    /**
     * 地区代码，存储最末一级的地区代码就可以
     */
    @ExcelCellBindAnnotation(title = "地区", width = 2, exception = ExceptionMsg.NOT_BLANK_EXCEPTION,exportSplit = ",")
     ...
     * 上级政府财政总收入
     */
    @ExcelCellBindAnnotation(title = "上级政府财政总收入", exception = ExceptionMsg.INCORRECT_FORMAT_EXCEPTION, size = BigDecimalUtils.ONE_HUNDRED_MILLION_STRING)
