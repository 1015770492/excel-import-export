...
public class PIMExcel {
    ...
    @ExcelTitleBind(title = "*权利类型", splitRegex = ",")
    private String rTIm;

    @ExcelTitleBind(title = "*使用年限")
    private String uLIm;

    @ExcelTitleBind(title = "*用途")
    private String pIm;

    @ExcelTitleBind(title = "*是否受限")
    private String iLIm;


    @ExcelTitleBind(title = "*是否国营主要物业或标志性资产")
    ...
    @ExcelTitleBind(title = "*宗地面积", nullable = true)
    ...
    @MapEntry(key = "平方米", value = "1")
    @MapEntry(key = "亩", value = "666.66667")
    @ExcelTitleBind(title = "*宗地面积单位", nullable = true)
    @CheckNullLogic(follow = "mSTIm", values = "8001301")
    ...
    @ExcelTitleBind(title = "*抵押类型")
    private String mTIM;

    @ExcelTitleBind(title = "*是否有评估价值")
    @NotEmpty(message = "是否有评估价值不允许为空")
    private String iAVIM;


    @ExcelTitleBind(title = "*评估报告类型", nullable = true)
    ...
    @ExcelTitleBind(title = "*评估机构", nullable = true)
    @CheckNullLogic(follow = "iAVIM", values = "是")
    private String aMIm;

    @ExcelTitleBind(title = "*评估报告名称", nullable = true)
    @CheckNullLogic(follow = "iAVIM", values = "是")
    private String aRNIm;

    @ExcelTitleBind(title = "*评估报告编号", nullable = true)
    @CheckNullLogic(follow = "iAVIM", values = "是")
    private String aRSIm;

    @CheckNullLogic(follow = "iAVIM", values = "是")
    @ExcelTitleBind(title = "*评估价值", nullable = true)
    ...
    @ExcelTitleBind(title = "*评估价值单位", nullable = true)
    ...
    @ExcelTitleBind(title = "*评估基准日", nullable = true)
    @CheckNullLogic(follow = "iAVIM", values = "是")
    private LocalDate aBDIm;

    @MapEntry(key = "出让", value = "0")
    @MapEntry(key = "划拨", value = "1")
    @ExcelTitleBind(title = "*权利性质")
    private String RP;

    @MapEntry(key = "受托管理人",value = "0")
    @MapEntry(key = "受权抵押权人",value = "1")
    @ExcelTitleBind(title = "*抵押权人")
    private String mHT;

    @ExcelTitleBind(title = "*受权抵押权公司名称", nullable = true)
    private String mE;

    @ExcelTitleBind(title = "*受权抵押权公司法定代表/责任人", nullable = true)
    private String mEI;

    @ExcelTitleBind(title = "*受权抵押权公司联系电话", nullable = true)
    private String mETel;

    @ExcelTitleBind(title = "*担保范围")
    @MapEntry(key = "正常", value = "0")
    @MapEntry(key = "特殊", value = "1")
    private String gR;

    @ExcelTitleBind(title = "*特殊说明", nullable = true)
    private String gRR;
}
