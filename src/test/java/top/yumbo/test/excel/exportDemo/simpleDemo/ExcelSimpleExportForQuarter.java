...
public class ExcelSimpleExportForQuarter {
     ...
     * 年份
     */
    @ExcelCellBindAnnotation(title = "时间", exportFormat = "%年", exportPriority = 1)
    private Integer year;

    /**
     * 季度，填写1到4的数字
     */
    @ExcelCellBindAnnotation(title = "时间", exportFormat = "第%s季", exportPriority = 2)
    private Integer quarter;

    /**
     * 地区代码，存储最末一级的地区代码就可以
     */
    @ExcelCellBindAnnotation(title = "地区", width = 2, exportSplit = ",")
