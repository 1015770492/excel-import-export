...
@TableHeader(height = 4, tableName = "区域季度数据", resource = "path:///D:/IdeaProjects/excel-import-export/src/test/java/top/yumbo/test/excel/2.xlsx")
...
public class ExportForQuarter {
    ...
    @TitleBind(title = "时间", exportFormat = "$0年")
    ...
    @TitleBind(title = "时间", exportFormat = "第$1季", exportPriority = 1)
    private Integer w2;
    // 下面的exportSplit是导出功能需要用到的
    @TitleBind(title = "地区", width = 2, exportSplit = ",", exportFormat = "$0,$1")
