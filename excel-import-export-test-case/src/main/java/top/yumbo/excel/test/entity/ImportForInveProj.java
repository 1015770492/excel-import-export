 ...
 */
@Data
@ExcelTableHeader(height = 8, sheetName = "项目总表",limitRowException = 0)
...
//    private String belongBatch;
    ...
    /** 总投资 （万元） */
    @ExcelTitleBind(title = "总投资（万元）",size = "10000")
    private BigDecimal totalInvestmentAmount;

    /**累计总投资 （万元）*/
    @ExcelTitleBind(title = "累计完成投资（万元）",size = "10000")
    ...
    /** 开工时间 */
    @ExcelTitleBind(title = "开工时间20XX.0X")
    private String constructionStartTime;

    /** 完工时间 */
    @ExcelTitleBind(title = "完工时间20XX.0X")
    ...
    /** 是否申请中央预算内投资 */
    @ExcelTitleBind(title = "是否申请中央预算内投资",nullable = false)
    @MapEntry(key = "是", value = "1")
    @MapEntry(key = "否", value = "0")
